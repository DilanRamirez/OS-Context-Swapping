...
//Funtion to show the number of cores that are running once the code is execute.
void printCPUs(){
    cpu_set_t mask;
    long nproc, i;
...
/*In the contextSwapping_Function() we will use two pipes to show how the process parent get blocked
...
*/
double contextSwapping_Function(){
